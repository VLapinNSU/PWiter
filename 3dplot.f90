...
call Grafik1D(Xcentr,P0,NN05,'NewtonP_2.plt')
call Grafik1D(Xcentr,W0,NN05,'NewtonW_2.plt')
...
call Grafik1D(Xcentr,P0,NN05,'RelaxP_2.plt')
call Grafik1D(Xcentr,W0,NN05,'RelaxW_2.plt')
